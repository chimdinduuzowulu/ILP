...
$_SESSION["EmailId"];
$studentNmae=$_SESSION["username"];
$studentEmail=$_SESSION["EmailId"];
$grade=$Fname=$Lname=$fullname="";

$studentInfo=$conn->query("SELECT * FROM StudentTable WHERE StudentEmailId='$studentEmail'");
if($studentInfo){
while($results=$studentInfo->fetch_assoc())
{
$grade=$results["Grade"];
$Fname=$results["Fname"];
$Lname=$results["Lname"];
...
<head>
    <meta charset="utf-8">
    <title>Student Page Uploads</title>
        ...
        <section class="module">
            <div class="module-inner">
                <div class="side-bar">
                    ...
                    <nav class="side-menu">
                        <ul class="nav">
                            <li><a href="studentprofile2.php"><span class="fa fa-user"></span> Profile</a></li>
                            <li><a href="studentSettings.php"><span class="fa fa-cog"></span> Settings</a></li>
                            <!-- <li class="active"><a href="#"><span class="fa fa-credit-card"></span> Billing</a></li> -->
                            <li><a href="studentChatroom.php"><span class="fa fa-envelope"></span>Chatroom</a></li>
                        ...
                        <div class="grid-items-wrapper">
                            <div class="drive-item module text-center">
                                <div class="drive-item-inner module-inner">
                                    <div class="drive-item-title"><a href="#"><?php echo $filename?></a></div>
                                    <div class="drive-item-thumb">
                                        <a href="#"><?php echo $files?></i></a> -->
                        ...
                        <div class="table-responsive drive-items-table-wrapper">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th class="type"></th>
                                        <th class="name truncate">Files</th>
                                        <th class="date">Uploaded</th>
                                        <th class="size">Course</th>
                                    </tr>
                                </thead>
                                <tbody>
<?php 
 $fetchfiles=$conn->query("SELECT * FROM CourseFiles WHERE GradeId='$grade'");
        if($fetchfiles){
        while($row=$fetchfiles -> fetch_assoc()){
                // echo "<script>alert(hey oka);</script>";
                $files = 'lecturerOperations/uploads'.$row["FileNames"];
...
?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="name truncate"><a href="pdf_server.php?file=<?php echo $filename;?>"><?php echo $filename?></a></td>
